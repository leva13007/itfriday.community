...
Але підтримка не означає однакову поведінку всюди. У різних браузерах можуть відрізнятися UX дозволів, політики енергозбереження, обмеження фонової активності, поведінка іконок, `badge`, `actions` та доставка повідомлень у режимах на кшталт Do Not Disturb або Focus. Тому в реальному продукті краще робити не browser detection, а feature detection:
...
На iPhone та iPad Web Push має важливе обмеження: він працює не для звичайної вкладки Safari, а для вебдодатка, який користувач додав на Home Screen. Підтримка з'явилася в iOS та iPadOS 16.4 для Home Screen web apps.
...
Головний висновок для iOS простий: Web Push там варто проектувати як PWA-сценарій, а не як функцію звичайної сторінки в браузері. Якщо користувач просто відкрив сайт у Safari і не додав його на Home Screen, підписка на push-сповіщення може бути недоступною.

## 4. Практична реалізація: Крок за кроком
...
## 5. Поведінка сповіщень: Кліки та взаємодія
