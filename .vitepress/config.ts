    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'Стати спікером', link: '/speak' },
          { text: 'Публікації', link: '/posts/' },
        ...
        socialLinks: [
          ...
          { icon: 'linkedin', link: 'https://www.linkedin.com/company/it-friday/' },
    ...
    en: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'Become a Speaker', link: '/en/speak' },
